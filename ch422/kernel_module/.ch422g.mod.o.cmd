cmd_/root/loongarch/drv_src/ch422g/ch422g.mod.o := loongarch64-linux-gnu-gcc -Wp,-MMD,/root/loongarch/drv_src/ch422g/.ch422g.mod.o.d  -nostdinc -isystem /root/loongarch/loongarch64-linux-gnu-gcc8-host-x86_64/bin/../lib/gcc/loongarch64-linux-gnu/8.3.0/include -I./arch/loongarch/include -I./arch/loongarch/include/generated  -I./include -I./arch/loongarch/include/uapi -I./arch/loongarch/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -DVMLINUX_LOAD_ADDRESS=0x9000000000200000 -fmacro-prefix-map=./= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -mno-check-zero-division -mabi=lp64 -G0 -pipe -msoft-float -ffreestanding -I./arch/loongarch/include/asm/mach-loongson64 -fno-asynchronous-unwind-tables -mstrict-align -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -O2 --param=allow-store-data-races=0 -Wframe-larger-than=2048 -fstack-protector-strong -Wimplicit-fallthrough -Wno-unused-but-set-variable -Wno-unused-const-variable -fomit-frame-pointer -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-stringop-truncation -Wno-array-bounds -Wno-stringop-overflow -Wno-restrict -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -Wno-packed-not-aligned  -DMODULE -fno-plt -Wa,-mla-global-with-abs,-mla-local-with-abs  -DKBUILD_BASENAME='"ch422g.mod"' -DKBUILD_MODNAME='"ch422g"' -c -o /root/loongarch/drv_src/ch422g/ch422g.mod.o /root/loongarch/drv_src/ch422g/ch422g.mod.c

source_/root/loongarch/drv_src/ch422g/ch422g.mod.o := /root/loongarch/drv_src/ch422g/ch422g.mod.c

deps_/root/loongarch/drv_src/ch422g/ch422g.mod.o := \
...
/root/loongarch/drv_src/ch422g/ch422g.mod.o: $(deps_/root/loongarch/drv_src/ch422g/ch422g.mod.o)
